...
export default function ExportMenu({ unexportedCount, onExportNew, onExportAll }) {
      ...
      {open && (
        ...
        >
          <button
            ...
            className="w-full px-4 py-3 text-left text-sm text-text transition-colors hover:bg-input"
          >
            Exporter tout
